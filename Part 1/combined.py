...
def main():
    ...
    filtered_relaxed_emg = butterworth_bandpass_filter(relaxed_emg, bandpass_lowcut, bandpass_highcut, sampling_rate)

    # Apply the Butterworth bandpass filter to 'emg_contracted' column
    filtered_contracted_emg = butterworth_bandpass_filter(contracted_emg, bandpass_lowcut, bandpass_highcut, sampling_rate)
